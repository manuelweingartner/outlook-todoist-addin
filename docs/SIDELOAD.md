...
Für Tests wird ein Microsoft 365 Developer-Tenant benötigt (kostenlos unter
...
2. Dev-Server starten:
   ...
   Das Skript versucht automatisch, Outlook zu öffnen und das Add-in zu laden.

---

## Manuelles Sideloaden im Dev-Tenant (Outlook im Web)

1. Outlook im Web im Developer-Tenant öffnen: https://outlook.office.com
2. Eine beliebige Mail öffnen.
3. Oben rechts das 3-Punkte-Menü wählen > "Apps abrufen" (oder direkt "Apps verwalten").
4. Im Apps-Dialog: "Eigene Add-ins" > "Aus Datei hochladen".
5. Die Datei `manifest.xml` aus dem Projekt-Root auswählen und bestätigen.
...
- CORS-Fehler: Todoist erlaubt Browser-Aufrufe mit Bearer-Token direkt (kein Proxy nötig).
